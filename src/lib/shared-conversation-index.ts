import type { SidebarConversationItem } from "@/components/chat/types";
import { canonAvatarMri } from "@/lib/teams-profile-avatars";
import type { ConversationMember } from "@/services/teams/types";

type SharedConversationEntry = {
  id: string;
  title: string;
  kind: SidebarConversationItem["kind"];
  preview: string;
  sideTime: string;
};
