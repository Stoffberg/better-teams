...
vi.mock("@better-teams/app/lib/teams-thread-preload", async () => {
  const actual = await vi.importActual<
    typeof import("@better-teams/app/lib/teams-thread-preload")
  >("@better-teams/app/lib/teams-thread-preload");
  return {
    ...actual,
...
import { PERF_FLAG, resetPerfStore } from "@better-teams/app/lib/perf";
...
describe("ChatWorkspace", () => {
  ...
  it("switches accounts and reloads conversations for the selected tenant", async () => {
    ...
    const { extractTokens } = await import(
      "@better-teams/app/lib/electron-bridge"
    );
